...
# num[4] 
num = [] 
for i in range(6): # i는 0에서부터 6미만까지 1씩증가
    num.append(i)
...
for i in f :
    print(i)
for i in range(len(f)): # 리스트의 길이len함수는 반복문에서 많이 사용
    print(f[i])
...
for i in range(len(num)): # range를쓸 경우 0부터 1씩 증가 
    # print(i) i : 0 , 1, 2, 3, ...  
